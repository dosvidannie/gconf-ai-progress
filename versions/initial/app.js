const categoryLabels = {
    ...
    const results = [
      ...
      {
        number: "06", date: "18–19 августа", category: "visual", status: "V1 завершена",
        title: "Личный AI-снэпборд",
        summary: "175 фотографий систематизированы в набор референсов, профиль внешности и итоговый 18-кадровый коллаж. Проект показал и силу, и пределы генерации идентичности.",
        details: ["Пять типов референсных листов и контроль исходников", "Коллаж 3000×3000 и 18 отдельных кадров", "Человеческое согласование ракурсов вместо автоматического «похоже»", "Ключевой вывод: точность лица не гарантируется даже при прямом референсе", "Лимиты генерации стали частью планирования, а не неожиданностью"]
      },
      {
      ...
      },
      {
        ...
        title: "Дневник обучения и GPT-коуч",
        summary: "Прогресс фиксировался не только результатами, но и утренней/вечерней рефлексией: один фокус, честная проверка FOMO и отделение красивого артефакта от реальной пользы.",
        details: ["Дневник новых навыков по датам", "Четыре визуальных отчёта", "Холодные тесты вместо преждевременной полировки", "Правило остановки после двух безрезультатных циклов", "AI как честное зеркало, а не генератор поддержки"]
      },
      {
      ...
      {
        number: "10", date: "13–17 августа", category: "work", status: "показано на демо",
        title: "Презентация рабочего кейса",
        summary: "Помощник обезличен, превращён в понятную историю и представлен на демо-дне — с живой демонстрацией вместо абстрактного рассказа.",
        details: ["Текст сокращён примерно с 850 до 540 слов", "Структура «было → правила → три варианта → финал»", "Живое демо сохранено без перегрузки слайдов", "Визуальный результат AI потребовал ручной доработки — граница инструмента зафиксирована честно"]
      }
    ];
    ...
    const timeline = [
      ...
      {date:"14–17 авг", source:"GCONF · демо", category:"work", title:"От рабочего файла — к доказанному кейсу", text:"Инструмент проверен на реальной съёмке, обезличен, представлен на демо-дне и получил подтверждение практической пользы."},
      ...
      {date:"21 авг", source:"Ретроспектива", category:"learning", title:"Разрозненные результаты собраны в одну систему", text:"История из нескольких проектов и папок превратилась в карту новых практик, продуктов, провалов, ограничений и следующих проверок."}
    ];
