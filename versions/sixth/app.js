const categoryLabels = {
    ...
    const results = [
      ...
      {
        number: "08", date: "6–26 августа", category: "learning", status: "ведётся",
      ...
      {
        number: "14", date: "25 августа", category: "product", status: "работает ежедневно",
        ...
        details: ["Запускается по расписанию", "Сверяет дневник с актуальной страницей", "Не добавляет планы, дубли и неподтверждённые результаты", "Сохраняет предыдущую версию в архиве", "Публикует обновление по постоянной ссылке"]
      },
      {
