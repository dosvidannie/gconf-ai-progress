const categoryLabels = {
    ...
    const results = [
      ...
      {
        number: "10", date: "август", category: "work", status: "представлено команде",
        ...
        details: ["Демо-день GConf: понятная история и живая демонстрация помощника", "Командный звонок: инструменты, наблюдения, идеи и удобные способы работы с AI", "Коллеги отметили, что мои проекты и подход вдохновили их на собственные эксперименты", "Опыт представлен через реальные рабочие результаты, а не абстрактный рассказ"]
      }
    ];
